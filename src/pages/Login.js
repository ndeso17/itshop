...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) {
      ...
      addToast(t("auth.otpSent") || "OTP has been sent to your email", "success");
    } else {
      addToast(result.error || t("auth.loginFailed"), "error");
    }
  ...
  const handleOTPVerify = async (email, device_id, otp) => {
    ...
    if (result.success) {
      ...
      addToast(t("auth.welcomeBack") || "Welcome back!", "success");
      navigate(from, { replace: true });
    } else {
      addToast(result.error || t("auth.otpFailed"), "error");
    }
  };
