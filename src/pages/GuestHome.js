            ...
            <div className="product-grid">
              {featuredProducts.length > 0 ? (
                featuredProducts.map((product) => (
                  ...
                  // Note: If you want to use the inline preview style from original file instead of ProductCard,
                  // I can revert to that. But for now I'm using the ProductCard component as requested previously
                  // for consistency. If you strictly want the *exact* previous look for cards too, let me know.
                  // However, ProductCard handles the new categories object best.
                ))
              ) : (
