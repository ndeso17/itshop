...
import { Filter, ChevronDown, ChevronUp, ArrowUp } from "lucide-react";
              ...
              {categories.map((cat) => (
                <button
                  ...
                  className={`category-tag ${
                    filterCategories.includes(cat) ? "active" : ""
                  }`}
              ...
              {Array(10)
                ...
                .map((_, index) => (
                  <div key={index} className="skeleton-card">
                    <Skeleton type="image" height="300px" className="mb-2" />
                    <Skeleton type="text" width="80%" height="18px" className="mb-1" />
