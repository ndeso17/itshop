...
const Register = () => {
  ...
  const validateForm = () => {
    ...
    // Regex ensuring at least: 1 uppercase, 1 lowercase, 1 number, 1 special char, 8+ length
    const passwordRegex = /^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&]).{8,}$/;
    if (!passwordRegex.test(formData.password)) {
      newErrors.password =
        "Password must contain uppercase, lowercase, number, and special character (e.g. @$!%*?&)";
    }
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          <div className="form-group">
            ...
            <div className="password-requirements mt-2">
              ...
              <ul className="list-unstyled mb-0 small">
                <li
                  className={`d-flex align-items-center ${formData.password.length >= 8
                      ? "text-success"
                      : "text-muted"
                    }`}
                >
                ...
                <li
                  className={`d-flex align-items-center ${/[A-Z]/.test(formData.password)
                      ? "text-success"
                      : "text-muted"
                    }`}
                >
                ...
                <li
                  className={`d-flex align-items-center ${/\d/.test(formData.password) ? "text-success" : "text-muted"
                    }`}
                >
                ...
                <li
                  className={`d-flex align-items-center ${/[@$!%*?&]/.test(formData.password)
                      ? "text-success"
                      : "text-muted"
                    }`}
                >
          ...
          <div className="form-group">
            ...
            {formData.confirmPassword && (
              <div
                className={`d-flex align-items-center mt-2 small ${formData.password === formData.confirmPassword
                    ? "text-success"
                    : "text-danger"
                  }`}
              >
