...
const Cart = () => {
  ...
  const removeItem = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        addToast(t("cart.removed") || "Removed from cart", "info");
      }
    });
  };
  ...
  const clearAllCart = () => {
    Swal.fire({
      title: t("cart.confirmClear"),
      text: t("cart.confirmClearText") || "This action cannot be undone",
      icon: "warning",
      showCancelButton: true,
      ...
      if (result.isConfirmed) {
        ...
        addToast(t("cart.cleared") || "Cart cleared", "success");
      }
    });
  };
    ...
    <div className="cart-page container">
      <div className="page-header-flex">
        <h1 className="page-title">
          {t("cart.shoppingCart")} ({cartItems.length})
        </h1>
        <button
