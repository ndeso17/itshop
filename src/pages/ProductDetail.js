...
const ProductDetail = () => {
  ...
  const handleAddToWishlist = () => {
    ...
    addToast(t("wishlist.added"), "info");
  };
      ...
      <div className="product-detail-page container">
        <div className="product-layout">
          <div className="product-gallery">
            <Skeleton type="image" height="500px" className="mb-2" />
            <div className="image-thumbnails" style={{ display: "flex", gap: "10px" }}>
          ...
          <div className="product-info-panel">
            <Skeleton type="text" width="30%" height="20px" className="mb-2" />
            <Skeleton type="title" width="80%" height="40px" className="mb-4" />
            <Skeleton type="text" width="40%" height="30px" className="mb-5" />
            <Skeleton type="text" width="100%" height="150px" className="mb-4" />
      ...
      <div className="product-reviews-section">
        ...
        <div className="review-form-modern fade-in">
          ...
          <button 
            ...
            onClick={() => {
              addToast(t("reviews.submitted") || "Review submitted for moderation", "success");
              setReviewText("");
              setReviewVariant("");
              setReviewFile(null);
            }}
